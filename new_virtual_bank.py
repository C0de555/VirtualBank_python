...
# FUNCTIONS
def admin_options():
    print("Type 'shut down' to shut down the virtual bank")
    print("Type 'add user' to add a new user")
...
def admin():
    admin_options()
    admin_choice = input("")
    if admin_choice == "shut down":
        print("Shutting down virtual bank...")
        exit()
    elif admin_choice == "add user":
        user_list.append(input("Username: "))
        user_pass.append(input("Password: "))
        balances.append(0)
        print("User added")
        admin()
    elif admin_choice == "log out":
        print("Logging out...")
        username = input("Please enter your username to begin: ")
        password = input("Please enter your password: ")
        get_valid_username_and_password(username, password)


def get_valid_username_and_password(username, password):
